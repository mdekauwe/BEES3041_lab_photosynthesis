...
Let's tweak these values and see how our functions response to temperature changes

```{r}
Vcmax <- peaked_arrh(p$Vcmax25, p$Eav, Tleaf, p$deltaSv, p$Hdv)
Vcmax2 <- peaked_arrh(p$Vcmax25, 40000, Tleaf, 650.0, p$Hdv)
...
ggplot(df, aes(Tleaf-DEG_2_KELVIN)) +
  geom_line(aes(y=Vcmax, colour="Vcmax")) +
  geom_line(aes(y=Vcmax2, colour="Vcmax - test")) +
