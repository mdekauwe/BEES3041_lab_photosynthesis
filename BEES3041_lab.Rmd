...
By comparing the simple LUE model with our more complicated model, can we spot any weaknesses in the model assumptions? For example, why does the LUE have a much stronger seasonality? What assumption do you think drive this? Can you test what you think the cause is by adjusting the LUE equation?
