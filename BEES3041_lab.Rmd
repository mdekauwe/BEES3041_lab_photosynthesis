...
df <- merge(df_day, df_obs_day, by="day")
colnames(df)<- c("day", "GPP_obs", "GPP_mod") 
...
Our simple model doesn't do that bad a job at simulating GPP at a larger scale, nevertheless there are some notable periods of dirergence. Why do you think the model underestimate GPP during the peak of summer? 




In order to read the meteorological
Explain about GPP
