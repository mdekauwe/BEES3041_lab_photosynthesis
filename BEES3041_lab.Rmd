...
ggplot(df, aes(PAR)) +
  geom_line(aes(y=out.Ac - out.Rd, colour="Ac")) +
  geom_line(aes(y=out.Aj - out.Rd, colour="Aj")) +
...
To do this we are going to have to make an assumption to scale our leaf-level model up to the canopy scale. We are going to use a big-leaf approximation 
