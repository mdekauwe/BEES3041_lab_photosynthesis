...
To apply the leaf-level model at a ~km^2^ scale, we are going to use a big-leaf approximation to scale up our leaf-level model. We are simply going to assume that:
