...
This should have been done earlier, it was one of the questions
I'm putting it here otherwise the code won't knit together - try not to peak!
...
# This should have been done earlier, it was one of the questions
# I'm putting it here otherwise the code won't knit together
```
...
GPP <- calc_lue(fPAR, df_par$PAR, T_scal, D_scal, emax)
